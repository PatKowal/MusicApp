    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(request->request
                        .requestMatchers(HttpMethod.POST, "/webapi/tracks").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/webapi/albums").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/webapi/albums/**").authenticated()
